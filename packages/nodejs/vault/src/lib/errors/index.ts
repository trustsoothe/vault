...
export const TransactionSentButInvalidErrorName = 'TransactionSentButInvalidError'

export class TransactionSentButInvalidError extends KeyringError {
  details: object

  constructor(details: object, message?: string) {
    super({
      name: TransactionSentButInvalidErrorName,
      message: message || 'Transaction sent but invalid',
    })
