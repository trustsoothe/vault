...
const enumValues = [DAOAction.Transfer, DAOAction.Burn] as const

if (enumValues.length !== Object.keys(DAOAction).length) {
  throw new Error('Mismatch between DAOAction and DAOActionArray')
}

export type DAOActionArray = typeof enumValues;
