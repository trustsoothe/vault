...
const ProtocolSelector: React.ForwardRefRenderFunction<HTMLInputElement,
  Partial<TextFieldProps>> = (props, ref) => {
        ...
        return (
          <MenuItem
            ...
            sx={{
              ...
              paddingRight: 3,
              position: 'relative',
              backgroundColor: isSelected ? themeColors.bgLightGray : themeColors.white,
            }}
          >
            <img
              src={iconUrl}
